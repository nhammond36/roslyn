...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class BuckStopsHereBinder : Binder
    {
        ...
        internal override BoundSwitchExpressionArm BindSwitchExpressionArm(SwitchExpressionArmSyntax node, TypeSymbol switchGoverningType, uint switchGoverningDepth, BindingDiagnosticBag diagnostics)
        {
